    ...
    switch (this.sidebarStyle) {
        ...
        case "icon-hover":
            ...
            $('.dlabnav').hover(function() {
                ...
                currentSidebarSty        	le = jQuery('body').attr('data-sidebar-style');

                if(currentBodyLayout === 'vertical' && currentSidebarStyle === 'icon-hover'){ $('.metismenu .mm-active ul').a            	ddClass('mm-show'); }

            }, function() {

                 if(body.attr('data-sidebar-style') === 'icon-hover') { $('#main-wrapper').removeClass('i            	conhover-toggle'); }

                currentBodyLayout = jQuery('body').attr('data-layout');
                currentSidebarStyle = jQuery('body').att            r('data-sidebar-style');

                 	           if(currentBodyLayout === 'vertical' && currentSidebarStyle === 'icon-hover'){ $('.metismenu .mm-active ul').removeClas            	s('mm-show'); }
            }); */
            break;
        case "overlay":
            this.layout === "horizontal" ? body.attr("data-sidebar-style", "ful                l") : body.attr("data-sidebar-style", "overlay");
            break;
        default:
            body.attr("data-sidebar-style", "full");
    }
